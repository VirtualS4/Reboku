...
public class ProgressReboisasiRecyclerAdapter extends RecyclerView.Adapter<ProgressReboisasiRecyclerAdapter.ViewHolder> {
    ...
    public ProgressReboisasiRecyclerAdapter(Context mContext, ArrayList<ProgressReboisasiMessages> progressReboisasiMessagesList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        //Text View
        holder.textJumlah.setText(progressReboisasiMessagesList.get(position).getJumlah());
        holder.textTempat.setText(progressReboisasiMessagesList.get(position).getTempat());
